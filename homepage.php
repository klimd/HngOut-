<html>
  ...
  <body id=bodyContent> 
    ...
    <div id=pageWrapper>
      ...
      <p style="color:white">Hey! This is HngOut! With HngOut, you can connect with other students to create events around campus or find existing ones.<p>
      <br>
    </div>
	<div id=informationText>
        ...
        <h1>Joining an Event</h1>
        <p>To join an already existing event, click on 'Find an Event'. On that page, search for events that you'd like to join. If you'd like to join the event, reach out to the creator of the event to RSVP.</p>
      </div>
      <br>
  </body>
</html>
